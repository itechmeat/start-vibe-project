...
- [ ] **List available skills** — Run: `npx add-skill itechmeat/llm-code --list`
  - Review which skills match project's technology stack from specs.md
  - Inform user which skills will be installed
- [ ] **Install matching skills** — Run: `npx add-skill itechmeat/llm-code -a {{aiTool}} --skill [skill-name] -y`
...
- [ ] **Search for missing skills** — Check https://skills.sh/?q=[technology] for additional skills
  - For each missing technology, search and install: `npx add-skill [skill-package] -a {{aiTool}} -y`
